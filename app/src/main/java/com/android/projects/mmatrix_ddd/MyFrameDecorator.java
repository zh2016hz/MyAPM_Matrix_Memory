...
public class MyFrameDecorator  extends IDoFrameListener implements IAppForeground {
    private static final String TAG = "Matrix.FrameDecorator";
    private WindowManager windowManager;
    private WindowManager.LayoutParams layoutParam;
    private boolean isShowing;
    private MyFloatFrameView view;
    private static Handler mainHandler = new Handler(Looper.getMainLooper());
    private Handler handler;
    private static MyFrameDecorator instance;
    ...
    private MyFrameDecorator(Context context, final MyFloatFrameView view) {
...
//        this.frozenColor = context.getResources().getColor(R.color.level_frozen_color);
        ...
        view.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() {
            ...
            public void onViewAttachedToWindow(View v) {
                ...
                if (Matrix.isInstalled()) {
                    ...
                    if (null != tracePlugin) {
                        ...
                        tracer.addListener(MyFrameDecorator.this);
                    }
                }
            }
            ...
            public void onViewDetachedFromWindow(View v) {
                ...
                if (Matrix.isInstalled()) {
                    ...
                    if (null != tracePlugin) {
                        FrameTracer tracer = tracePlugin.getFrameTracer();
                        tracer.removeListener(MyFrameDecorator.this);
                    }
                }
            }
        });
    ...
    private void updateView(final MyFloatFrameView view, final float fps, final int belongColor,
    ...
    public static MyFrameDecorator get() {
        return instance;
    }

    public static MyFrameDecorator getInstance(final Context context) {
        if (instance == null) {
            if (Thread.currentThread() == Looper.getMainLooper().getThread()) {
                instance = new MyFrameDecorator(context, new MyFloatFrameView(context));
            } else {
                try {
                    synchronized (lock) {
                        mainHandler.post(new Runnable() {
    ...
    public MyFloatFrameView getView() {
        return view;
    }
